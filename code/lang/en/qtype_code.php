...
/**
 * Strings for component 'qtype_code', language 'en', version '4.0'.
 *
 * @package    qtype_code
 * @subpackage lang
 * @category   string
...
$string['formateditorfilepicker'] = 'Monaco editor with file picker';
...
$string['pluginnameadding'] = 'Adding an code question';
$string['pluginnameediting'] = 'Editing an code question';
$string['pluginnamesummary'] = 'Allows a response of a file upload and/or online text. This must then be graded manually.';
$string['privacy:metadata'] = 'code question type plugin allows question authors to set default options as user preferences.';
$string['privacy:preference:defaultmark'] = 'The default mark set for a given question.';
$string['privacy:preference:responseformat'] = 'What is the code language (csharp, javascript, etc.)?';
...
$string['responseformat'] = 'Programming language';
