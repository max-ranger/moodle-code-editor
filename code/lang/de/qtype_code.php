...
/**
 * Strings for component 'qtype_code', language 'de', version '4.0'.
 *
 * @package    qtype_code
 * @subpackage lang
 * @category   string
...
$string['formateditor'] = 'Monaco Editor';
$string['formateditorfilepicker'] = 'Monaco Editor mit Dateiauswahl';
...
$string['pluginname'] = 'Programmiersprache';
...
$string['pluginnameadding'] = 'Programmiersprachenfrage hinzufügen';
$string['pluginnameediting'] = 'Programmiersprachenfrage bearbeiten';
$string['pluginnamesummary'] = 'Eine Programmiersprachenantwort erlaubt eine Antwort als Datei und/oder als Onlinetext. Diese Antwort muss manuell bewertet werden.';
$string['privacy:metadata'] = 'Das Plugin "Programmiersprache-Frageformat" erlaubt es Frageautor/innen, standardmäßige Optionen als Nutzereinstellungen zu setzen.';
...
$string['privacy:preference:responseformat'] = 'Welche Programmiersprache soll abgefragt werden (csharp, javascript, etc.)?';
...
$string['responseformat'] = 'Programmiersprache';
