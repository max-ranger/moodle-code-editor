...
$string['pluginnameadding'] = 'Quelltextfrage hinzufügen';
$string['pluginnameediting'] = 'Quelltextfrage bearbeiten';
$string['pluginnamesummary'] = 'Eine Quelltextantwort erlaubt eine Antwort als Datei und/oder als Onlinetext. Diese Antwort muss manuell bewertet werden.';
$string['privacy:metadata'] = 'Das Plugin "Quelltext-Frageformat" erlaubt es Frageautor/innen, standardmäßige Optionen als Nutzereinstellungen zu setzen.';
...
$string['privacy:preference:responseformat'] = 'Welche Quelltext soll abgefragt werden (csharp, javascript, etc.)?';
...
$string['responseformat'] = 'Quelltext';
